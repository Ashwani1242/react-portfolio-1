  ...
  return (
    <motion.div
      ...
      <ul className='md:flex md:space-x-[1px] md:space-y-0 space-y-[1px] bg-black border border-black w-min font-semibold'>
        ...
        <a href={resume} download='resume' className='bg-white cursor-pointer group relative py-2 px-4'>
          <p className='relative inset-0 flex items-center justify-center z-20 group-hover:text-white duration-500'>
            Resume
